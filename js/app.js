...
const PRODUCTS = [
...

  {
    ...
    colors: [
      { name: "Blue",
        images: [
          "assets/Shamrock/Canners/Case.jpg",
          "assets/Shamrock/Canners/Blue.png"
        ]
      },
      { name: "Orange",
        images: [
          "assets/Shamrock/Canners/Case.jpg",
          "assets/Shamrock/Canners/Orange.png"
        ]
      },
      { name: "Yellow",
        images: [
          "assets/Shamrock/Canners/Case.jpg",
          "assets/Shamrock/Canners/Yellow.png"
        ]
      },
    ],
    category: "Industrial",
...
function renderProductPage() {
  ...
  const imageArray = selectedColor?.images || product.images || (Array.isArray(product.image) ? product.image : [product.image]) || [assets/placeholder.jpg];
  ...
  page.innerHTML = `
    <div class="product-detail">
      <div class="image-gallery">
        ...
        <img src="${mainImage}" alt="${product.name}" class="main-image" id="main-image" loading="lazy">
